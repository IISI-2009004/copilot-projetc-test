...
| 時間           | 里程碑               | 說明                                                                                                                                                                                                     |
| -------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **2025-08**    | 概念提出             | Kieran Klaassen 發表 _["My AI Had Already Fixed the Code Before I Saw It"](https://every.to/source-code/my-ai-had-already-fixed-the-code-before-i-saw-it)_，首次提出「Compounding Engineering」概念      |
| **2025-11**    | Plan-first 策略      | Kieran Klaassen 發表 _["Stop Coding and Start Planning"](https://every.to/source-code/stop-coding-and-start-planning)_，深入探討 AI Agent 時代的規劃優先策略                                             |
| **2025-12**    | 方法論系統化         | Dan Shipper & Kieran Klaassen 共同發表 _["Compound Engineering: How Every Codes With Agents"](https://every.to/chain-of-thought/compound-engineering-how-every-codes-with-agents)_，闡述四步驟工程方法論 |
