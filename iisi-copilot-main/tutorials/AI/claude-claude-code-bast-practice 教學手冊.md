...
```json
{
  "autoMode": {
    ...
    "allow": ["$defaults", "Allow running npm test without prompting"]
  }
}
```
...
```jsonc
{
  ...
  "extraKnownMarketplaces": ["https://marketplace.company.com"],

  // 嚴格模式：僅允許已知 Marketplace 的 Plugin
  "strictKnownMarketplaces": true,

  // 封鎖的 Marketplace
  "blockedMarketplaces": ["https://untrusted.example.com"],
}
```
...
// Managed Settings — 企業 MCP 安全策略
{
  ...
  "mcpAllowlist": ["github.company.internal", "jira.company.internal"]
}
```
